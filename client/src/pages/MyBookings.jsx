      ...
      <motion.div
        ...
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex gap-2">
            <span className="px-4 py-2 bg-white rounded-xl shadow-sm text-sm font-semibold text-gray-700 border border-gray-100 flex items-center gap-2">
          ...
          <AnimatePresence>
            {bookings.length === 0 && (
              ...
              >
                ...
                <p className="text-gray-500 mt-2 max-w-md">You haven't made any car reservations yet. Start exploring our fleet to find your perfect ride.</p>
              </motion.div>
            )}
                ...
                <div className='lg:col-span-6 flex flex-col justify-center border-t lg:border-t-0 lg:border-l border-gray-200/60 pt-6 lg:pt-0 lg:pl-8 relative z-10'>
                  ...
                  <div className='flex flex-col bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden group-hover:border-primary/20 group-hover:shadow-md transition-all duration-300'>
                    ...
                    <div className='flex items-center justify-between p-5 bg-gray-50/50'>
                      ...
                      <span className={`relative overflow-hidden px-4 py-1.5 text-[10px] font-black uppercase tracking-[0.1em] rounded-full flex items-center gap-2 transition-all duration-500 shadow-sm border ${
                        ...
                        <span className="relative flex h-2 w-2">
                          ...
                          <span className={`relative inline-flex rounded-full h-2 w-2 ${
                            booking.status === 'confirmed' ? 'bg-emerald-500' : booking.status === 'cancelled' ? 'bg-slate-400' : 'bg-amber-500'
                          }`}></span>
                        </span>
