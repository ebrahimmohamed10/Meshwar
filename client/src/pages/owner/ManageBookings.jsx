                  ...
                  <tr key={index} className="hover:bg-gray-50/50 transition-colors group">
                    ...
                    <td className="py-4 px-6 whitespace-nowrap">
                      <div className="flex items-center">
                        <img src={booking.car.image} alt="" className="h-10 w-14 object-cover rounded shadow-sm border border-gray-100 mr-3"/>
                        <div>
                          <div className="text-sm font-medium text-gray-900">{booking.car.brand}</div>
                    ...
                    <td className="py-4 px-6 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">
                         ...
                         {new Date(booking.returnDate).toLocaleDateString('en-GB', {day: '2-digit', month: 'short'})}
                      </div>
